...
| -- | -- | -- | -- | -- | -- |
| ndvi | Normalized Difference Vegetation Index (NDVI) | Measures the greenness of vegetation. Higher values indicate healthier, denser vegetation. | **Application:** Measures the greenness of vegetation. <br> <br> **Uses:** Crop monitoring, forest management, vegetation health assessment. | 
